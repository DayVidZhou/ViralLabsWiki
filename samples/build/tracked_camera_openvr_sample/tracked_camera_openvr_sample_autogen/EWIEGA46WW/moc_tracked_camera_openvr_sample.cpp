...
const QMetaObject CQCameraPreviewImage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CQCameraPreviewImage.data,
      qt_meta_data_CQCameraPreviewImage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CQCameraPreviewImage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CQCameraPreviewImage.stringdata0))
        return static_cast<void*>(const_cast< CQCameraPreviewImage*>(this));
...
void CQTrackedCameraOpenVRTest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CQTrackedCameraOpenVRTest *_t = static_cast<CQTrackedCameraOpenVRTest *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject CQTrackedCameraOpenVRTest::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_CQTrackedCameraOpenVRTest.data,
      qt_meta_data_CQTrackedCameraOpenVRTest,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CQTrackedCameraOpenVRTest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CQTrackedCameraOpenVRTest.stringdata0))
        return static_cast<void*>(const_cast< CQTrackedCameraOpenVRTest*>(this));
